#!/usr/bin/env zsh
# Generated by Powerlevel10k configuration wizard on 2023-06-05 at 19:52 EDT.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 12407.
# Wizard options: compatible, lean_8colors, unicode, 12h time, 2 lines, solid,
# full frame, white-ornaments, sparse, fluent, transient_prompt, instant_prompt=verbose.
